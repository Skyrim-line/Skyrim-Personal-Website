...
export const photoData = [
  ...
  {
    src: img5,
    info: "Great Barrier Reef, 2023",
    description:
      "The Great Barrier Reef is the world's largest coral reef system, located in the Coral Sea off the coast of Queensland, Australia. It is one of the seven natural wonders of the world.",
  },
  {
    src: img6,
    info: "Uluru, 2023",
